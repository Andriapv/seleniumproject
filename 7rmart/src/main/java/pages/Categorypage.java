...
public class Categorypage {
	...
	WebElement createnewcategorybutton;
	@FindBy(xpath = "//input[@id='category']")
	WebElement categoryfield;
	@FindBy(xpath = "//li[@id='134-selectable']")
	WebElement selectgroupdiscountdraganddrop1;
	@FindBy(xpath = "//li[@id='134-selection']")
	WebElement selectgroupdiscountdraganddrop2;
	...
	List<WebElement> elementsearch;
	@FindBy(xpath = "//a[@class='btn btn-sm btn btn-primary btncss']")
	WebElement updatebutton;
	@FindBy(xpath = "//input[@id='category']")
	WebElement categoryfieldinupdate;
	@FindBy(xpath = "//button[@type='submit']")
	WebElement submitbuttonupdate;
	@FindBy(xpath = "//div[@class='alert alert-success alert-dismissible']")
	WebElement successfullalertinupdate;
	@FindBy(xpath = "//a[@class='btn btn-sm btn btn-danger btncss']")
	WebElement deletebuttonincategory;
	@FindBy(xpath = "//div[@class='alert alert-success alert-dismissible']")
	WebElement successfullalertindelete;
	...
	public boolean elementSearchinginCategory() {
		return pg.elementSearching(elementsearch, "Beetroot");
