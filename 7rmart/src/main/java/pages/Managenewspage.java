...
public class Managenewspage {
	...
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/news/add']") WebElement newbuttonmanagenews;
	@FindBy(xpath="//textarea[@class='form-control']") WebElement newstextareafield;
	@FindBy(xpath="//button[@name='create']") WebElement savebuttoninmanagenews;
	@FindBy(xpath="//div[@class='alert alert-success alert-dismissible']") WebElement alertmessage;
	@FindBy(xpath="//a[@class='btn btn-rounded btn-primary']") WebElement searchbutton;
	@FindBy(xpath="//input[@name='un']") WebElement searchfield;
	...
	public boolean iselementpresentintable()
	{
		    ...
		    String searchelement = "hello";
		    boolean flag = false;
		      if (tablesearch != null && !( tablesearch). isEmpty()) {
		    	  for (WebElement searching : tablesearch) 
		        {
		            if (searching.getText().trim().equalsIgnoreCase(searchelement)) {
		                flag = true;
		                break;
		            }
		        }
